...
import 'package:realtor/widgets/app_bar/appbar_title.dart';
...
class EditProfileScreen extends GetWidget<EditProfileController> {
     ...
     child: Column(
      ...
      children: [
       ...
       CustomTextFormField(
        ...
        fontStyle: TextFormFieldFontStyle.RalewaySemiBold12Bluegray80001,
        suffix: Container(
         margin: getMargin(left: 30, top: 25, right: 16, bottom: 25),
        ...
        suffixConstraints: BoxConstraints(maxHeight: getVerticalSize(70)),
       ),
       CustomTextFormField(
        focusNode: FocusNode(),
        ...
        fontStyle: TextFormFieldFontStyle.MontserratSemiBold12Bluegray80001,
        textInputAction: TextInputAction.done,
        suffix: Container(
         margin: getMargin(left: 30, top: 25, right: 16, bottom: 25),
         child: CustomImageView(svgPath: ImageConstant.imgTrashBlueGray80001),
        ),
        suffixConstraints: BoxConstraints(maxHeight: getVerticalSize(70)),
       ),
       CustomDropDown(
        ...
        fontStyle: DropDownFontStyle.RalewaySemiBold12Bluegray80001,
        items: controller.editProfileModelObj.value.dropdownItemList,
        onChanged: (value) {
         ...
         children: [
          Expanded(
           child: CustomButton(
            ...
            fontStyle: ButtonFontStyle.RalewaySemiBold12WhiteA700_1,
          ...
          Expanded(
           child: CustomButton(
            ...
            shape: ButtonShape.CircleBorder25,
            padding: ButtonPadding.PaddingT25,
            fontStyle: ButtonFontStyle.RalewaySemiBold12Bluegray80001,
            prefixWidget: Container(
             margin: getMargin(right: 10),
 ...
 onTapChooseLocation() {
  Get.toNamed(AppRoutes.locationChooseLocationScreen);
 }
}