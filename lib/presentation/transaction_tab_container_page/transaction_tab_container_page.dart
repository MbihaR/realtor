...
import 'package:realtor/presentation/listings_page/listings_page.dart';
import 'package:realtor/presentation/transaction_page/transaction_page.dart';
import 'package:realtor/widgets/custom_icon_button.dart';

// ignore_for_file: must_be_immutable
class TransactionTabContainerPage extends StatelessWidget {
  TransactionTabContainerController controller =
  Get.put(TransactionTabContainerController(TransactionTabContainerModel().obs));
                ...
                children: [
                        ...
                        children: [
                          ...
                          CustomIconButton(
                            ...
                            child: CustomImageView(
                              svgPath: ImageConstant.imgC6f6d1d0a80c478fac3dcfbb08744752,
                            ),
                          ),
                        ],
                      ),
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        CustomIconButton(
                          ...
                          child: CustomImageView(
                            svgPath: ImageConstant.img9ce8cff206464d90abe590abdd2875e0,
                          ),
                        ),
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
                      style: AppStyle.txtRalewaySemiBold10.copyWith(letterSpacing: getHorizontalSize(0.3)),
                    ),
                  ),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          padding: getPadding(left: 29, top: 16, right: 29, bottom: 16),
                          decoration: AppDecoration.outlineBluegray501.copyWith(borderRadius: BorderRadiusStyle.circleBorder20),
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                                style: AppStyle.txtMontserratBold14.copyWith(letterSpacing: getHorizontalSize(0.42)),
                              ),
                              Padding(
                                ...
                                child: Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                                  style: AppStyle.txtMontserratMedium10.copyWith(letterSpacing: getHorizontalSize(0.3)),
                                ),
                              ),
                            ],
                          ),
                        ...
                        Container(
                          ...
                          padding: getPadding(left: 39, top: 16, right: 39, bottom: 16),
                          decoration: AppDecoration.outlineBluegray501.copyWith(borderRadius: BorderRadiusStyle.circleBorder20),
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: getPadding(left: 1, top: 5, bottom: 1),
                                child: Text(
                                  "lbl_reviews".tr,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                      ...
                      children: [
                        Container(
                          ...
                          child: TabBar(
                            ...
                            unselectedLabelColor: ColorConstant.indigo200,
                            ...
                            tabs: [
                              Tab(
                                child: Text("lbl_transaction".tr, overflow: TextOverflow.ellipsis),
                              ),
                              Tab(
                                child: Text("lbl_listings".tr, overflow: TextOverflow.ellipsis),
                              ),
                              Tab(
                                child: Text("lbl_sold".tr, overflow: TextOverflow.ellipsis),
                              ),
                            ],
                          ),
                        ),
  ...
  onTapAddListing() {
    Get.toNamed(AppRoutes.formDetailScreen);
  }

  onTapSettings() {
    Get.toNamed(AppRoutes.paymentEmptyScreen);
  }
}